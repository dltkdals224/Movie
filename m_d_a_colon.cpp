	...
	while ((c = getc(director_list)) != EOF) {
		if (*head == NULL) {
			...
			*(array + i) = c;
			...
			for (int a = 0;*(((*head)->name->str) + a) != '\0';a++) {
				if (*(((*head)->name->str) + a) == '?'&&*(((*head)->name->str) + a + 1) == '?'&&*(((*head)->name->str) + a + 2) == ';') {
			...
			*(array + i) = c;
			...
			for (int a = 0;*(((*temp)->name->str) + a) != '\0';a++) {
				if (*(((*temp)->name->str) + a) == '?'&&*(((*temp)->name->str) + a + 1) == '?'&&*(((*temp)->name->str) + a + 2) == ';') {
	...
	while ((c = getc(movie_list)) != EOF) {
		if (*head == NULL) {
			...
			*(array + i) = c;
			...
			for (int a = 0;*(((*head)->title->str) + a) != '\0';a++) {
				if (*(((*head)->title->str) + a) == '?'&&*(((*head)->title->str) + a + 1) == '?'&&*(((*head)->title->str) + a + 2) == ';') {
			...
			for (int a = 0;*(((*head)->genre->str) + a) != '\0';a++) {
				if (*(((*head)->genre->str) + a) == '?'&&*(((*head)->genre->str) + a + 1) == '?'&&*(((*head)->genre->str) + a + 2) == ';') {
			...
			for (int a = 0;*(((*head)->director->str) + a) != '\0';a++) {
				if (*(((*head)->director->str) + a) == '?'&&*(((*head)->director->str) + a + 1) == '?'&&*(((*head)->director->str) + a + 2) == ';') {
			...
			*(array + i) = c;
			...
			for (int a = 0;*(((*temp)->title->str) + a) != '\0';a++) {
				if (*(((*temp)->title->str) + a) == '?'&&*(((*temp)->title->str) + a + 1) == '?'&&*(((*temp)->title->str) + a + 2) == ';') {
			...
			for (int a = 0;*(((*temp)->genre->str) + a) != '\0';a++) {
				if (*(((*temp)->genre->str) + a) == '?'&&*(((*temp)->genre->str) + a + 1) == '?'&&*(((*temp)->genre->str) + a + 2) == ';') {
			...
			for (int a = 0;*(((*temp)->director->str) + a) != '\0';a++) {
				if (*(((*temp)->director->str) + a) == '?'&&*(((*temp)->director->str) + a + 1) == '?'&&*(((*temp)->director->str) + a + 2) == ';') {
